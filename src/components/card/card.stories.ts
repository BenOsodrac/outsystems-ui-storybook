...
const Template = (args) => `<div style="width: 400px">
                                <osui-card alignment="${args.alignment}" reverse-column="${args.reverseColumn}" border="${args.border}" background-color="${args.backgroundcolor}" show-header="${args.showHeader}">
                                    ...
                                    <img style="height: 250px;display: block; width: 100%;object-fit: cover;" width="100%" slot="content" src="https://outsystemsui.outsystems.com/OutSystemsUIWebsite/img/StyleGuidePreviewAssets.PatternPreviewPhoto10.png" alt="">
